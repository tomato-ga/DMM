...
oneweek = datetime.now().replace(microsecond=0)
oneweek = (oneweek - timedelta(days=7)).isoformat() #TODO 1日前にしている
...
# try:
while True:
    json_url = f'https://mizugazo.com/wp-json/wp/v2/media?per_page={count}&offset={response_offset}&after={oneweek}'
