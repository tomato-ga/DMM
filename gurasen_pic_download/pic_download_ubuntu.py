...
class Image:
    ...
    def image_url_parse(self, url, count):
        ...
        try:
            ...
            os.makedirs(f'/mnt/hdd/don/files/twitphotos_gurasen/{count}', mode=0o777 , exist_ok=True) #  mode=0o777 , exist_ok=True
            for img_url in img_urls:
                ...
                if image_get.status_code == 200:
                    ...
                    with open(f'/mnt/hdd/don/files/twitphotos_gurasen/{count}/{str(file_name)}{file_ex}', 'wb') as image: #Win f'E:\\twit_photos\\{title}\\{str(file_name)}.jpg', 'wb' # Ubuntu f'/mnt/hdd/don/files/twitphotos/{title}/{str(file_name)}.jpg', 'wb'
