...
def new_follow_id(client) -> dict[str]:
    ...
    # 1521876334074818560 グラビアアイドルのリスト 1532272699044937728 裏垢 1570707822614310914
    response = client.get_list_tweets(id=1570707822614310914, max_results=15,  expansions=["attachments.media_keys","referenced_tweets.id"])
