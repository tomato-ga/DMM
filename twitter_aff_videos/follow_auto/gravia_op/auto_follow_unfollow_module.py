...
def new_follow_id(client) -> dict[str]:
    ...
    # 1521876334074818560 グラビアアイドルのリスト 1567125930664927235 裏垢 1514978714572173313
    response = client.get_list_tweets(id=1567125930664927235, max_results=15,  expansions=["attachments.media_keys","referenced_tweets.id"])
