...
if __name__ == '__main__':
    ...
    load_json = [
        json.load(open('/home/don/py/DMM/DMMAPI/master_fanza_genre_spanking_videofile.json')),
    ...
    i = Tweet()
    i.Uploads(account='OtxSf', up_file=upload_path_and_file_name) #text='今日はこれでぬきぬき！', up_url=upload_url
    i.Quit()
