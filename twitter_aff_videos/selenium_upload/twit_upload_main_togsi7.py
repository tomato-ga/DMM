...
if __name__ == '__main__':
    ...
    load_json = json.load(open('/home/don/py/DMM/DMMAPI/JSON/master_fanza_genre_bust90to99_videofile.json')),
    ...
    i = Tweet()
    i.Uploads(account='togsi7', up_file=upload_path_and_file_name, text=upload_title) #text='いいね！', up_url=upload_url,
    i.Quit()
