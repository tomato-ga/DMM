...
if __name__ == '__main__':
    ...
    upload_path_and_file_name: str = '/mnt/hdd/don/files/fanza/jd_cut/' + upload_file_name
    assert os.path.isfile(upload_path_and_file_name)
    print(upload_path_and_file_name, ':', upload_url, upload_title)

    i = Tweet()
    i.Uploads(account='jdlovedoga', up_file=upload_path_and_file_name, text=upload_title)
    i.Quit()
