...
if __name__ == '__main__':
    load_json = json.load(open('/home/don/py/DMM/DMMAPI/JSON/master_fanza_genre_2000_videofile.json')),
    ...
    upload_path_and_file_name: str = '/mnt/hdd/don/files/fanza/2000_cut/' + upload_file_name
    assert os.path.isfile(upload_path_and_file_name)
    print(upload_path_and_file_name, ':', upload_url, upload_title)

    i = Tweet()
    i.Uploads(account='after2000_v', up_file=upload_path_and_file_name, text=upload_title)
    i.Quit()
