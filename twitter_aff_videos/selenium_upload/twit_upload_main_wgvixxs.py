...
if __name__ == '__main__':
    load_json = json.load(open('/home/don/py/DMM/DMMAPI/JSON/master_fanza_genre_女子校生_videofile.json')),
    ...
    upload_path_and_file_name: str = '/mnt/hdd/don/files/fanza/jk_cut/' + upload_file_name
